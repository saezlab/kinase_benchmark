...
if 'snakemake' in locals():
   ...
   input_file = '../../../../results/hernandez/benchmark_files/strict/RoKAI_z-phosphositeplus_networkin.csv'
   meta_data = '../../../../results/hernandez/benchmark_files/strict/obs_RoKAI_z-phosphositeplus_networkin.csv'
   output_file = '../../../../results/hernandez/benchmark_res/tmp/bench_RoKAI_z-phosphositeplus_networkin.csv'
