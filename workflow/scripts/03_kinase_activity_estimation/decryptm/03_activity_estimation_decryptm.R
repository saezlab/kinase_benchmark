if(exists("snakemake")){
  ...
  dataset_name <- snakemake@wildcards$decryptm_measurement
  ...
  dataset_name <- "R2_pEC50"
  PKN <- "results/decryptm/prior/GPS.tsv"
  PKN_name <- "GPS"
  output_file <- "results/decryptm/activity_scores/R2_pEC50_GPS.rds"
